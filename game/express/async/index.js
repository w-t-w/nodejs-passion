...
//     next();
//
//     if (response.player_won) player_won_count++;
// }, (request, response) => {
//     const {query} = request;
//     const {action} = query;
//
...
//
//     if (result === player_won_code) response.player_won = true;
//
//     response.status(200);
...
console.log(`NodeJS 《第十三课: 异步事件同步调用使用 commonjs 模块化导入导出规范,express 网页程序中直接使用石头、剪刀与布游戏》部分已热情的学习研究完毕!如需重试,将以上代码注释解开即可!`);
